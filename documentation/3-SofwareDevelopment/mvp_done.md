...
| MVP-DT-005 | CodeValdCross Registration | 2026-04-27 | `feature/DT-001_module-scaffolding` | Landed as `internal/registrar/registrar.go`; SharedLib heartbeat at 20 s default; `Produces:` enumerates `dt.entity.created`, `dt.telemetry.recorded`, `dt.event.recorded`. |
